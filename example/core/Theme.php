...
use Example\Helper\FeaturesLoader;
use Example\Helper\Router;
use Example\Helper\Navigation;
use Example\Helper\ACF;
use Example\Helper\WPML;
use Example\Helper\TinyMCE;
...
final class Theme {
  ...
  private function setup()
  {
    ...
    // customizing ACF
    ACF::enableLocalJSON();
    ACF::addOptionsPage('options', __('Theme Options', 'example'));
  }
